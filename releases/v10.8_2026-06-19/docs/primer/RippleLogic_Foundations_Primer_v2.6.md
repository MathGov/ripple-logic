MathGov / RippleLogic Foundations Primer

Version 2.6 (Informative)

Version 2.6, synchronized companion edition for Canon v10.8 / SGP v5.5 / ripple.md v3.6 / Agent System v10.8 / Primer v2.6 / Aligners Sheet v3.6. Package line: MathGov / RippleLogic Core Release 2026.07 applies the Reality Grounding and Lean Cascade Patch, including structure-transition-consequence vocabulary, status-vs-trace discipline, and release-pin cleanup.

Companion to Canon v10.8 / SGP v5.5 / ripple.md v3.6 / Agent System v10.8 / Primer v2.6 / Aligners Sheet v3.6

MathGov Institute for Ethical Systems Design

# Abstract

This primer is the human doorway into MathGov, RippleLogic, and the Sentience Gradient Protocol. It explains why the framework exists, what problem it addresses, what it claims, what it does not claim, and how the main pieces fit together. It is informative only: the Canon and companion specifications remain the source of normative force.

## Plain-language summary

Decisions ripple outward. They affect people, institutions, ecosystems, future generations, and sometimes intelligences that are not yet well understood. MathGov/RippleLogic gives readers a structured five-level method: Reality Grounding, Rights Floor, Tail-Risk Bound, Containment, and Ripple Score. In simpler words: ground the facts, protect the floor, bound ruin, preserve the whole, and choose the best ripple. The framework makes ethical reasoning auditable rather than merely rhetorical.

## How to read this primer

Begin with Sections 1 and 2 for the problem and basic identity of the framework. Then read Sections 3, 3A, 3B, and 3C for layer discipline, primitive audit, reference-structure reasoning, and Category Grounding. Use later sections to understand the cascade, SGP, audit posture, and release boundaries.
...
Five-level method. MathGov/RippleLogic is now best taught as: Reality Grounding -\> Rights Floor -\> Tail-Risk Bound -\> Containment -\> Ripple Score. Formal shorthand: RSG -\> NCRC -\> TRC -\> Containment -\> RLS.
...
A number is not automatically truth. A score is useful only when the evidence behind it is visible, the uncertainty is disclosed, the affected stakeholders can be identified, and reviewers can challenge the assumptions. When the evidence is not strong enough, RippleLogic should not pretend certainty. It should narrow the claim, escalate for review, run sensitivity analysis, or refuse the stronger decision state.
...
MathGov/RippleLogic is not a magic calculator. It does not make ethics automatic, and it does not remove human, legal, democratic, scientific, or professional responsibility. It makes ethical reasoning more structured, inspectable, rights-constrained, uncertainty-aware, and contestable.
...
Because the territory exceeds every modeled surface and audit operates only on the surface, no run can certify that all unmodeled catastrophic or containment-breaking effects are absent. Because catastrophic outcomes are, by the TRC definition, potentially irreversible or unbounded, folding them into an average computes over a tail finite knowledge cannot reliably bound and misrepresents an uncompensable loss as compensable. This is why the non-averagable treatment of catastrophic risk and the Containment Gate follow from P1 under finitude rather than being optional severities added later.
...
### P3. Stakeholders Exist Within Nested Unions

No entity exists in complete isolation for governance-relevant domains. Persons, institutions, technologies, animals, ecosystems, and future intelligences exist within nested patterns of interdependence. The canonical operational stack used in RippleLogic Tier 1 to Tier 3 computation is U1 Self, U2 Household, U3 Community, U4 Organization, U5 Polity, U6 Collective Managing Intelligence Union (CMIU, also called Humanity), U7 Biosphere. Two further layers, U8 Cosmic and U9 Universal/AIU, are recognized as non-computational meta-unions and serve only as humility horizons and precautionary amplifiers under the current release line.

> Statement: All decision-relevant beings and systems exist within nested unions of relationship and consequence.
...
A system can win locally while damaging the larger system it depends on. A company can profit while destroying worker health. A nation can grow while degrading the biosphere. An AI lab can advance capability while raising alignment risk. This is the basis of the Containment gate.

> Statement: No system may optimize one layer of reality by destabilizing the larger systems that sustain it.

### P8. Moral Consideration Scales With Sentience

A rock, a bacterium, a tree, a forest, a dolphin, an elephant, an orangutan, a human, and a future artificial intelligence do not occupy identical ethical positions. Moral consideration should not be based on species membership, power, familiarity, or economic convenience alone. The Sentience Gradient Protocol assigns protection-relevant moral status under uncertainty according to evidence of awareness, agency, welfare/valence capacity, and union-participation capacity. Within the current canonical line, the human plateau (SG_norm(H) = 1.0) is treated as absolute; class-level and entity-level plateau assignments outside humans follow governed SGP procedure.

> Statement: Moral consideration is assigned according to evidence of sentience and welfare-bearing capacity, under uncertainty, with the human plateau treated as absolute.
...
Category Grounding is not a sixth step. It belongs inside Reality Grounding when material. The five-level method remains: Reality Grounding -\> Rights Floor -\> Tail-Risk Bound -\> Containment -\> Ripple Score.
...
Reviewers should ask: What does this term mean? What boundary defines it? What belongs inside it? What does not belong inside it? What reference structure tests it? What evidence surface supports it? What would force revision? What happens if this category is wrong?
...
Moral status is not all-or-nothing. Evidence of awareness, welfare/valence capacity, agency, self-modeling, learning, communication or species-appropriate behavioral markers, and union-participation capacity can support graduated estimates. SGP procedures are designed to make these estimates governed, auditable, and corrigible rather than ad hoc. The human plateau is treated as absolute.
...
Open standards, public documentation, audit trails, and reproducible decision records reduce capture risk. Open does not guarantee integrity, but closed systems are easier to monopolize, manipulate, and hide.
...
MathGov must remain corrigible, evidence-responsive, and open to structural improvement, otherwise it ossifies into dogma. At the same time, corrigibility itself requires a floor: the rights gate, the catastrophic-risk gate, the containment gate, and the auditability commitment cannot be revised away by ordinary stakeholder process. Revision of these floors is constitutional in character and requires governed extension protocol, not ordinary update.
...
Level 4, Containment. Among admissible options, does this option preserve sufficient integrity of the larger system that contains the local gain? An option that fails Containment is not selectable, even if it ranks highly on residual welfare.

Level 5, Ripple Score / RLS. Among selectable options, which produces the best residual welfare pattern under the declared weighting regime? RLS ranks; it does not rescue failures in Reality Grounding, NCRC, TRC, or Containment.
...
Rights-admissible. The option passes NCRC.

Admissible. The option passes NCRC and TRC.

Selectable. The option is admissible and passes Containment (Mode A).

Selected. The option is chosen from the selectable set after RLS, tie-break, and any required escalation disposition.
...
For example, if a decision lacks enough evidence to determine whether a protected subgroup is harmed, the correct result is not to assume safety. If a scenario model cannot determine whether catastrophic risk is inside the corridor, the correct result is not to average the uncertainty away. If a sentience claim relies only on fluent language or self-report, the correct result is not to treat that as proof of moral patienthood.
...
Sentience is not intelligence. Capability and welfare-bearing capacity are distinct. A highly capable system may not be a moral patient; a moral patient may not be highly capable. SGP scoring tracks the second; capability evaluation tracks the first.

Admissibility is not optimization. NCRC, TRC, and Containment are feasibility gates. RLS is welfare ranking. They have different inputs, different operators, and different failure consequences. A welfare maximum that is not admissible is not selectable; an admissible option with mediocre RLS is still selectable.

# Section 10. SGP Integration: Plateau, Scalar Binding, Authority Boundary

Current Human Plateau / CMIU clarification. Humans are not treated as full-plateau beings because of arbitrary species preference. Human persons receive non-degradable protection so rights cannot become a capacity test, and humanity currently provides the evidenced calibration anchor for reality-managing intelligence within the Collective Managing Intelligence Union (CMIU). This does not make humans metaphysically superior, and it does not close the plateau to non-human biological or artificial entities that meet the governed standard.

SGP v5.5 is the canonical companion specification for moral status, rights of protection, and graduated moral consideration across substrates. Three SGP commitments matter most for foundational understanding.

## 10.1 The human plateau is absolute

Human moral status is treated as plateau-bearing with SG_norm(H) = 1.0. This plateau is not subject to downward revision through ordinary update procedure. Class-level plateau assignments for non-human entities follow governed SGP class-level plateau records; entity-level plateau assignments follow governed individual plateau records. Plateau status is not inferred informally from taxon evidence alone.

## 10.2 SGP scalar binding: welfare stream only

SGP-derived welfare-stream scaling (s_k) is applied only in the welfare stream used for RLS ranking, using SG_patient_norm(E) where available and otherwise SG_norm(E), while preserving the Human Plateau Rule and leaving admissibility layers unchanged. Admissibility layers (NCRC, TRC, Containment) operate on the base stream with s_k set to 1. This separation is non-negotiable: SGP weighting cannot be used to lower a rights floor, soften a catastrophe gate, or weaken a containment check. SGP shapes residual welfare comparison among already-feasible options; it does not shape feasibility.

## 10.3 The authority boundary

SGP confers grounds for protection and for inclusion in welfare and rights computation. SGP does not confer decision authority over other stakeholders, governance role, voting weight, or institutional power. The separation between moral status and authority is constitutive: a being can be highly protected and have no governance role, and an entity can hold legitimate authority while being morally considerable on the same terms as everyone else.
...
> 1.  Define the decision. State what is being decided, who is deciding, what options exist, and what happens under no action. Declare tier and configuration.
>
> 2.  Map stakeholders across affected unions. Identify the relevant scope chain from U1 Self through U7 Biosphere; note where U8 Cosmic or U9 Universal/AIU humility considerations apply.
>
...
>
> 4.  Apply NCRC. For each option, check whether any rights-covered cell crosses a non-compensatory minimum on the worst-off protected subgroup. Eliminate any option that fails.
>
> 5.  Apply TRC. For each rights-admissible option, evaluate CVaR over the governed scenario set against the declared corridor. Eliminate any option that exceeds the corridor; record TRC fallback if invoked.
>
> 6.  Apply Containment (Mode A where required). For each admissible option, evaluate cross-scale structural feasibility; eliminate or escalate any option that degrades a containing union beyond tolerance.
>
...
>
> 8.  Make weights, evidence, and uncertainty visible. Declare union weights, dimension weights, evidence quality, stakeholder input, expert adjustments, uncertainty bands, and sensitivity tests in the PCC.
>
...
# Section 11B. Execution Stability in Plain Language

A decision is not finished merely because an option can be described, scored, or technically executed. Before a consequence-bearing action becomes real, RippleLogic now asks one additional practical question: what kind of transition are we about to enter?

The Execution Stability Diagnostic classifies the transition itself. It asks whether the move preserves viable continuation, requires monitoring, creates bounded destabilization, intentionally closes an endpoint, fails containment, or remains underdetermined. This helps prevent a system from treating execution as automatic just because a draft, instruction, or score exists.

This does not make stability the highest moral value. Some stable systems are unjust. Some necessary reforms temporarily disturb existing arrangements. RippleLogic therefore keeps the order clear: rights floors, catastrophic-risk bounds, containment, and legitimate authority come first. Stability is a diagnostic about the transition into consequence, not a permission slip to preserve oppression or avoid needed repair.

Plain-language rule. Do not ask only, can this be done? Ask: should this transition become real, under this evidence, with these affected stakeholders, this reversibility profile, this monitoring plan, and this claim boundary?

Simple example. If an institution wants to deploy a new AI assistant, the ordinary cascade asks whether rights are protected, tail risk is bounded, containment is preserved, and welfare improves. The execution stability check then asks whether deployment is reversible, whether failure modes are monitored, whether users have recourse, whether the system can be rolled back, and whether any endpoint-like consequence is being created without proper authority.
...
# Section 13. What v10.8 Integrates and Completes: Scoring Literacy, Stream Separation, SGP v5.5, and Release Boundaries

Current completion note. Core Release 2026.07 contains RippleLogic Canon v10.8, SGP v5.5, ripple.md v3.6, Agent System v10.8, Primer v2.6, and Aligners Sheet v3.6. The line preserves the core cascade while adding decision-verdict hardening, openability repair, and the Reality Grounding and Lean Cascade Patch: structure-transition-consequence vocabulary, vehicle/content/effect separation, surface/territory discipline, status-vs-trace audit flags, and non-averagability derivation under finitude.

The v10.1–v10.8 methodology hardening does not change the soul of MathGov or the core RippleLogic cascade. It makes the scientific posture stricter. A high-stakes claim should not merely sound coherent, fit the past, or be compatible with observed outcomes. It should declare what would count against it before the evidence is used to protect it.
...
The v10.8 method does not claim final truth, perfect objectivity, complete prediction, or immunity from formal limits. It says something more practical: every serious claim must carry its own audit trail, evidence boundary, and reality-facing test.
...
For example, a rights floor may pass or fail. A tail-risk corridor may be exceeded or not exceeded. A containment relation may hold or fail. But the evidence used to evaluate these gates can involve measurement error, incomplete models, probability estimates, contested data, or human judgment.

The v10.8 rule is simple: do not pretend uncertainty is gone merely because the decision surface needs a yes/no answer. Binary gates make governance accountable. Evidence humility keeps the binary answer honest.
...
Current maturity note. Canon v10.8 is complete as the current core specification for this release line. SGP v5.5 is complete as the current moral-status and protection protocol. ripple.md v3.6, Agent System v10.8, Primer v2.6, and Aligners Sheet v3.6 are synchronized companions. Biological SGP measurement remains guidance-stage rather than measurement-complete, and stronger empirical or ProofPack claims remain non-claimable without separate evidence.

RippleLogic is mature as an architecture and decision methodology for its declared Tier 1-3 scope, but not every measurement surface is equally mature. This distinction protects the framework from overclaiming and helps reviewers understand where deployment caution is required.

## 14.1 Mature now

The cascade architecture is specified: rights floors first, then tail risk, containment, residual scoring, and structural diagnostics.
...
RippleLogic Canon v10.8 is the governing artifact. It defines the cascade, equations, admissibility gates, PCC requirements, claim boundaries, conformance vocabulary, reality-grounding records, schema ownership boundaries, and machine-readable registry expectations.

SGP v5.5 is the companion moral-status and protection protocol. It provides welfare-relevant protection scalars and evidence objects. It does not grant governance authority and does not override RippleLogic admissibility gates.

ripple.md v3.6 is the portable alignment contract and assurance wrapper. It helps implementations record evidence, decision notes, update legitimacy, reality-grounding fields, refusal conditions, and deployment assurance. It does not replace the Canon.

RippleLogic Agent System v10.8 governs agent deployment, security posture, mode control, operator authority, audit logging, reality-reference closure, refusal, rollback, and runtime conformance. It does not authorize an agent to bypass the Canon.

Ripple Aligners Sheet v3.6 is a worked-run exemplar and training companion. It helps users inspect and replay a sample run, including FrameworkVerdict and RealityGroundingStatus surfaces. It is not a ProofPack, semantic validator, or reference calculator.

Foundations Primer v2.6 is explanatory and carries no normative force. It helps readers understand MathGov and RippleLogic in plain language.
...
Machine-readable registries, schemas, CI checks, reference calculators, and calibration packs are tooling-line ProofPack-prep surfaces. Unless separately listed in the release manifest, they are not bundled in the v10.8 core foundation release. They improve machine-checkability and replay readiness but do not by themselves create Tier 4 readiness.

Foundations Primer v2.6 is informative and carries no normative force. This release is not an empirical-validation claim, not ProofPack-ready, not machine-verifiable-ecosystem-complete, and not Tier 4-ready. Stronger claims require separate schemas, validators, reference calculators, replayable PCC artifacts, calibration evidence, and independent replay instructions.
...
MathGov may be described as a proposed ethical operating system or civilizational operating-system candidate when speaking about its design ambition. That language should remain subordinate to the evidence. The current claimable status is more modest: MathGov/RippleLogic is a governance-and-alignment research program with a partially calculable ethical decision architecture, an assurance wrapper, and an agent governance companion.
...
# Section 16. Why v10.8 Focuses on Integration, Not Grand Claims
...
A framework can become more trustworthy by saying less, checking more, and refusing false certainty. The v10.8 line should be read in that spirit: a clearer, more integrated release foundation, not a claim of empirical completion.
...
The practical path is staged: v10.8 is the clean core foundation; the v10.8 tooling line develops replayability; later empirical releases must test inter-rater reliability, reconstructability, and shadow-mode pilots before stronger operational-readiness claims are made.

Final release-readiness interpretation. This primer is release-clean as an informative explanatory companion only. It should not be cited as a normative source of conformance, empirical validation, ProofPack readiness, machine-verifiable ecosystem completeness, or Tier 4 readiness.

## Glossary Binding

All technical terms used in this primer (NCRC, TRC, Containment, RLS, UCI, HOI, PCC, NCAR, HDW, PLSS, SGP, SG_norm, SG_patient_norm, plateau, rights-admissible, admissible, selectable, selected, Refusal, ProjectionPreRegistration, ComputationalClosure, CategoryCollapseSelfTest, RealityGroundingRecord, RealityGroundingStatus, CMIU, UBR, UBE, MNA, Bridge Premises, Stewardship, Execution Stability Diagnostic, PCC.ExecutionStabilityRecord, ESC_STABLE, ESC_DESTABILIZING_BOUNDED, ESC_ENDPOINT_REFUSED, ESC_UNDERDETERMINED, ripple.md, Aligners) are defined canonically in RippleLogic Canon v10.8 Appendix L and SGP v5.5. This primer defers to those definitions and adds none of its own.

## Version History

v2.6 (Informative). Synchronized to Core Release 2026.07 and companion artifacts: RippleLogic Canon v10.8 / SGP v5.5 / ripple.md v3.6 / Agent System v10.8 / Aligners Sheet v3.6. Added the Reality Grounding and Lean Cascade Patch, Category Grounding / Primitive Audit explanation, structure-transition-consequence vocabulary, measurement-maturity and deployment-context clarification, HDW capture, PLSS escalation, UCI readiness, kernel posture, biological SGP maturity, and release-boundary cleanup.

v2.1 (Informative). Re-pinned to RippleLogic Canon v10.1 / SGP v4.9 / ripple.md v3.1 / Agent System v10.1 / Aligners v3.1; added transition-admissibility and evidence-humility explanation. No normative claims added; companion-to-canon role unchanged.
...
v1.5 (Informative). Added a plain-language Execution Stability section, updated release-line pins to v10.0 / SGP v4.8 / ripple.md v3.0, and clarified that stability is a transition diagnostic subordinate to rights, tail-risk, containment, and legitimate authority.
...
This document is an Informative companion to MathGov / RippleLogic Core Release 2026.07, governed by RippleLogic Canon v10.8. Its purpose is to make the foundations of MathGov, RippleLogic, and the Sentience Gradient Protocol (SGP) understandable to educated human readers in plain language, without weakening or replacing the normative content of the Canon.
...
Pinning: This primer is pinned to RippleLogic Canon v10.8, SGP v5.5, ripple.md Standard v3.6, RippleLogic Agent System v10.8, and Aligners Sheet v3.6. Any successor release line should re-pin this primer or supersede it explicitly.
...
# Section 18. v2.6 Update: Computable Is Not Automatically Admissible

## 18.1 Plain-language rule

MathGov v10.8 adds one important clarity rule: a number can exist without being allowed to decide. A spreadsheet can calculate a score for an option that already failed rights protection. An AI can produce a confident recommendation that lacks authority. A sentience score can be estimated while still being too immature for a strong claim. In those cases, the output is computable but inadmissible.
...
The v10.8 line also adds an Adaptive Reserve diagnostic. Some systems fail because they are too chaotic; others fail because they are too tightly optimized and have no slack left. A decision can look efficient while making a family, institution, ecosystem, or society brittle. Adaptive Reserve asks whether enough recovery capacity, redundancy, attention, and reversibility remain after the decision.

## 18.4 v2.6 release delta

The Primer v2.6 explains the Canon v10.8 / SGP v5.5 layer-discipline update in plain language, including Canon Appendix AE. It remains informative only and does not replace the Canon, SGP, ripple.md, Agent System, or Aligners Sheet.

# Section 19. v2.6.1 Update: Framework Verdict Is Not Authority Selection
...
# Section 20. v2.6 Update Summary: Reality Grounding and Lean Cascade

The v2.6 primer teaches the five-level method: Reality Grounding -\> Rights Floor -\> Tail-Risk Bound -\> Containment -\> Ripple Score.
