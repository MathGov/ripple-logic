...
Options A and D fail the Rights Floor (formal NCRC). Option A: unreviewed outputs create unacceptable risk of dignity and information integrity violations in adversarial threads. Option D: browsing and tool use create unacceptable attack surface for information manipulation. Options B and C pass all rights floors.
