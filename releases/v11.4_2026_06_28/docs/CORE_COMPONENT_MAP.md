...
| Aligners Sheet | v4.4 | Worked-run exemplar workbook | Tier 1-3 exemplar, not validator | Substantial worked-run completeness | M1 worked-run model; formula audit pending; not calibrated |
