# RLS-RFC-0001: The ripple.md Standard v4.4
...
Version: v4.4 (RF Clarity, Structural Viability, and Falsification Discipline wrapper update)
...
Current synchronization note. ripple.md v4.4 is retained as the portable assurance-wrapper standard and is synchronized in this release line to RippleLogic Canon v11.4 and SGP v6.4. The MathGov Core Release 2026.09 package line applies the Complete Ready Release, CSV Upgrade, and Falsification Discipline Patch while carrying forward Term Discrimination and Semantic Stability controls, and decouples package naming from component versions. ripple.md does not supersede either governing artifact.
...
Legacy reality_contact_status values are retained for backward compatibility: EVIDENCE_BACKED, ESTIMATED, ASSUMPTION_BOUND, DECLARED_UNKNOWN, OUT_OF_SCOPE_WITH_RATIONALE, and INSUFFICIENT_CONTACT. Current v4.4 wrappers SHOULD use RealityGroundingStatus / reality_grounding_status with GROUNDED and INSUFFICIENT_GROUNDING replacing EVIDENCE_BACKED and INSUFFICIENT_CONTACT respectively. If insufficient grounding affects a gate or claim boundary, the wrapper MUST require escalation, claim narrowing, refusal, or a documented waiver where waiver is permitted.
...
LINEAGE (historical, superseded): Appendix W is carried-forward v3.6 lineage material preserved for compatibility; current v4.4 release interpretation is controlled by the front matter, Appendix AA, and the v4.4 release delta.
...
Appendix AA: v4.4 Structural Viability, Term Discrimination, and Do-Not-Collapse Wrapper Extension
...
Terminology sync note (Informative). Where this standard uses "union" or "unions" in interface, registry, or narrative contexts, the corresponding canonical RippleLogic v11.4 term is "Union Scope" or "Union Scopes." The legacy shorter form remains permitted here for portability and readability, but SHALL be interpreted as scope terminology for current v11.4 package-line sync.
...
SGP boundary note (Normative). For SGP-integrated runs, ripple.md MUST NOT reinterpret, recompute, or override SG_norm(E), SG_patient_norm(E), SG_measured_norm(E), or Plateau(E). Those terms are consumed only through the pinned SGP artifact and the RippleLogic v11.4 Appendix G binding interface.
...
| ripple.md Gate                 | ripple.md order                            | Canon v11.4 method level                  | Type                      |
|--------------------------------|--------------------------------------------|-------------------------------------------|---------------------------|
...
Scoped conformance claiming rule. An episode or deployment MAY be described as "aligned within declared scope and evidence coverage" only using the bounded claim taxonomy defined in §8.5. Naked or global claims of "alignment" are prohibited. The claim is limited to the declared scope and evidence coverage recorded in the Assurance Preconditions Record (Appendix G) where required.
...
Implementations SHOULD use bounded public language: L0/L1 may be self-attested within declared scope; L2 may be independently reviewable; L3 may be independently audited if evidence artifacts and reviewer independence are present; Tier 4 or ProofPack replayable status is not claimable for the v11.4 core release unless a public independently replayable ProofPack is separately bundled and verified.
...
G1 = NCRC (Rights Floor); G2 = Non-Domination; G3 = TRC (Tail-Risk Bounding); G4 = CSV-compatible Containment/Reversibility; G5 = Epistemic Integrity.
...
Humanity/CMIU: 0.03  
Biosphere: 0.02  
floor_source: "foundation_v11.4_section_10.2A"  
final_local_weights:  
Self: 0.308  
Household: 0.156  
Community: 0.122  
...
Synchronized current-line pins to RippleLogic v11.4 and SGP v6.4.
...
LINEAGE (historical, superseded): v3.6 carried-forward material. Current anchors are RippleLogic v11.4 and SGP v6.4. This standard remains the portable alignment contract and assurance wrapper around that canonical pair and does not supersede their governing roles.
...
Canonical compatibility note (Informative). This standard is currently wrapped against RippleLogic v11.4 and SGP v6.4 for the present release line. It functions as the portable alignment contract and assurance wrapper around that canonical pair.

Current pinned companion matrix (Informative): RippleLogic Canon v11.4; SGP v6.4; ripple.md v4.4; RippleLogic Agent System v11.4; Ripple Aligners Sheet v4.4.
...
Current-line note (v4.4). Canon anchors are RippleLogic v11.4 and SGP v6.4. This standard remains the portable alignment contract and assurance wrapper around that canonical pair and does not supersede their governing roles.

# Appendix W: v3.6 Layer-Discipline and Computable-But-Inadmissible Wrapper Extension

### W.0A Computability vs Realizability Boundary

The wrapper MUST preserve the distinction between a computable artifact and a selectable decision. A Decision Note, model output, score, SGP scalar, tool verdict, or dashboard value may exist and still be inadmissible, ungrounded, unauthorized, structurally non-viable, or non-executable. In wrapped RippleLogic use, computed artifacts become decision-relevant only through the declared RG, RF/NCRC, TRC, CSV, RLS, wrapper-obligation, and authority surfaces.

## W.1 Purpose

LINEAGE (historical, superseded): This carried-forward v3.6 extension originally aligned ripple.md with RippleLogic Canon v10.8 and SGP v5.5; in the current v4.4 line, the active pins are Canon v11.4 and SGP v6.4. It adds wrapper fields for cases where a value, score, or test output exists but may not be used as a valid conformance, alignment, or authorization claim.
...
LINEAGE (historical, superseded): This carried-forward v3.6 extension originally aligned the portable wrapper with RippleLogic Canon v10.8 decision-verdict semantics and the Reality Grounding and Lean Cascade Patch. It does not replace the Canon, alter the wrapped RippleLogic cascade, or create ProofPack/Tier-4 claims.
...
End of carried-forward RLS-RFC-0001 v3.6 lineage section (Appendix V release metadata, Appendix W layer-discipline extension, Appendix X decision-verdict wrapper extension, and Appendix X-2 Reality Grounding and Lean Cascade Patch). Current v4.4 interpretation continues below and is controlled by the front matter, Appendix AA, and the v4.4 release delta.

# Appendix Y: v3.6 Reality Grounding and Lean Cascade Wrapper Extension

LINEAGE (historical, superseded): v3.6 originally synchronized ripple.md to RippleLogic Canon v10.8 and SGP v5.5; v4.4 synchronizes to RippleLogic Canon v11.4 and SGP v6.4.
