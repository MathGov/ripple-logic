# MathGov Triggered Record Surface Matrix v1.0

## Purpose

Candidate onboarding artifact addressing the complexity/auditability paradox. It distinguishes baseline run records from records activated only by material triggers. It does not waive any gate or safeguard.
...
| RLS record | Survivors only | Survivors only | Survivors only | No |
...
A record is not made optional merely because it is inconvenient. "Not triggered" requires a short rationale and a reopen condition where materiality could change.
