# RippleLogic RLS Validation Protocol v2.4
...
Companion validation protocol for MathGov Core Release 2026.09 v12.4 and the RippleLogic v12.4 Canon.
...
| Artifact                                 | Role                                                                               |
| ---------------------------------------- | ---------------------------------------------------------------------------------- |
| RippleLogic_RLS_Validation_Protocol_v2_4 | Study protocol, rater instructions, hypotheses, analysis plan, and revision rules. |
| RLS_Validation_Workbook_v0.2             | Rater-entry and analysis-prep workbook.                                            |
...
## v12.4 mandatory conformance vectors
