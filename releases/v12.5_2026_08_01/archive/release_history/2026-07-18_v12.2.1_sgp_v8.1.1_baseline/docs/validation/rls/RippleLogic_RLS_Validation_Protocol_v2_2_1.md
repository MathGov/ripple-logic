# RippleLogic RLS Validation Protocol v2.2.1

Companion validation protocol for MathGov Core Release 2026.09 v12.2.1 and the RippleLogic v12.2.1 Canon.
...
| Artifact                                 | Role                                                                               |
| ---------------------------------------- | ---------------------------------------------------------------------------------- |
| RippleLogic_RLS_Validation_Protocol_v2.0 | Study protocol, rater instructions, hypotheses, analysis plan, and revision rules. |
...
## v12.2.1 mandatory conformance vectors
...
## v12.2 Tier-Integrity Conformance Vectors (Normative for protocol conformance)
...
3. `TIER2_CSV_REDESIGN_BLOCKS_RLS`: an option with `CSV_REDESIGN_REQUIRED` is excluded before scoring.
...
## Appendix: v12.2 source-integrity vectors
