# **MathGov 3R / 1-2 Two-Phase Public Introduction v12.6**

## **v12.6 Current Release Integration**
...
The framework stays the same at every level. Only the documentation burden changes. A user must escalate when rights, ruin, vulnerable groups, physical execution, consequential AI authority, or public validation claims become material. See `docs/implementation/MATHGOV_REPRODUCIBILITY_AND_USE_STANDARD_v1.4.md`.
...
## **SGP v8.5: protection, participation, and power are separate**
