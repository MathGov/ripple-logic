...
## ripple.md L2/L3 dependency boundary

The core package is self-contained for L0/L1 wrapper learning and basic Decision Note practice. L2/L3 conformance paths that depend on recourse auditability, redaction/access control, or coercion/emergency projection require the applicable RPAP/PFAP companion protocols to be separately bundled or hash-pinned. Without those companions, do not claim L2/L3 ripple.md conformance from this package alone.

## No automated judgment by design

The package now includes a run-record schema and semantic validator, but it intentionally does not automate evidence evaluation, rights interpretation, scenario completeness, welfare scoring validity, lawful authority, or physical safety. Those remain human/governed and domain-specific tasks.
