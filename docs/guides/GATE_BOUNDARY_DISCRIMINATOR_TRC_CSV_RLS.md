...
**Status:** companion hardening guide for MathGov Core Release 2026.09 v12.3. Canon controls if conflict occurs.
...
RippleLogic should be taught as: **first qualify options, second rank survivors.**

- **Phase 1 qualification:** RG establishes claim authority; RF/NCRC protects rights; TRC bounds ruin; CSV verifies structural viability and containment.
- **Phase 2 ranking:** RLS orders only the selectable survivors.

This two-phase frame preserves the five-level cascade. It does not merge gates and does not add a sixth gate.
...
## Why TRC must remain separate

TRC exists because ordinary scoring and ordinary viability checks fail under ruin risk. An option can be structurally viable and still expose a decision surface to unacceptable catastrophe, irreversible harm, lock-in, systemic collapse, or non-recoverable loss. That is why TRC is not absorbed into CSV.

CSV asks whether the vessel can stand. TRC asks whether the downside can be responsibly risked at all. Both questions are necessary.
